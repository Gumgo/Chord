    ...
    export
    {
      ...
      struct SimdOperationImplementation<u64, 2, SimdOperation::Set> : public SupportedSimdOperationImplementation
      {
        static __m128u64 Run(u64 v0, u64 v1)
          { return _mm_set_epi64x(s64(v1), s64(v0)); }
      };
      ...
      template<>
      struct SimdOperationImplementation<u64, 2, SimdOperation::Gather> : public SupportedSimdOperationImplementation
      {
        static __m128u64 Run(const u64* baseAddress, const __m128s64& v)
          { return _mm_i64gather_epi64(reinterpret_cast<const s64*>(baseAddress), v, sizeof(u64)); }
      };
      ...
      struct SimdOperationImplementation<u64, 2, SimdOperation::GetElement> : public SupportedSimdOperationImplementation
      {
        ...
        static u64 Run(const __m128u64& v, std::integral_constant<usz, Index>)
        {
          if constexpr (Index == 0)
            ...
            { return u64(_mm_extract_epi64(v, Index)); }
        }
      };
      ...
      template<>
      struct SimdOperationImplementation<u64, 2, SimdOperation::CastS32> : public SupportedSimdOperationImplementation
      {
        static __m128s32 Run(const __m128u64& v)
          { return v.m_value; }
      };

      template<>
      struct SimdOperationImplementation<u64, 2, SimdOperation::CastS64> : public SupportedSimdOperationImplementation
      {
        static __m128s64 Run(const __m128u64& v)
          { return v.m_value; }
      };
      ...
      template<>
      struct SimdOperationImplementation<u64, 2, SimdOperation::CastU32> : public SupportedSimdOperationImplementation
      {
        static __m128u32 Run(const __m128u64& v)
          { return v.m_value; }
      };

      template<>
      struct SimdOperationImplementation<u64, 2, SimdOperation::CastU64> : public UnsupportedSimdOperationImplementation
        { };

      template<>
      struct SimdOperationImplementation<u64, 2, SimdOperation::CastF32> : public SupportedSimdOperationImplementation
      {
        static __m128 Run(const __m128u64& v)
          { return _mm_castsi128_ps(v); }
      };

      template<>
      struct SimdOperationImplementation<u64, 2, SimdOperation::CastF64> : public SupportedSimdOperationImplementation
      {
        static __m128d Run(const __m128u64& v)
      ...
      {
        static __m128u64 Run(const __m128s64& condition, const __m128u64& trueValue, const __m128u64& falseValue)
      ...
      template<>
      struct SimdOperationImplementation<u64, 2, SimdOperation::TestMaskNone> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m128u64& v)
          { return _mm_testz_si128(v, v) != 0; }
      };

      template<>
      struct SimdOperationImplementation<u64, 2, SimdOperation::TestMaskAny> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m128u64& v)
          { return _mm_testz_si128(v, v) == 0; }
      };
      ...
      template<>
      struct SimdOperationImplementation<u64, 2, SimdOperation::TestMaskAll> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m128u64& v)
      ...
      template<>
      struct SimdOperationImplementation<u64, 2, SimdOperation::TestMaskSome> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m128u64& v)
      ...
      template<>
      struct SimdOperationImplementation<u64, 2, SimdOperation::FromMask> : public SupportedSimdOperationImplementation
      {
        static __m128u64 Run(s32 mask)
        {
          __m128i bits = _mm_set_epi64x(2, 1);
          return _mm_cmpeq_epi64(_mm_and_si128(_mm_set1_epi64x(mask), bits), bits);
        }
      };
    }
  }
