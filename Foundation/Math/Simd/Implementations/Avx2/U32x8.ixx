...
namespace Chord
{
  export
  {
      ...
      {
        template<u32 Index>
        static u32 Run(const __m256u32& v, std::integral_constant<u32, Index>)
        {
      ...
      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::NarrowAndCombine> : public UnsupportedSimdOperationImplementation
        { };
