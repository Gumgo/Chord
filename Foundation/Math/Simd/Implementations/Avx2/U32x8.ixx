    ...
    export
    {
      ...
      struct SimdOperationImplementation<u32, 8, SimdOperation::SetSingle> : public SupportedSimdOperationImplementation
      {
        static __m256u32 Run(u32 v)
          { return _mm256_set1_epi32(s32(v)); }
      };
      ...
      struct SimdOperationImplementation<u32, 8, SimdOperation::Set> : public SupportedSimdOperationImplementation
      {
        static __m256u32 Run(u32 v0, u32 v1, u32 v2, u32 v3, u32 v4, u32 v5, u32 v6, u32 v7)
          { return _mm256_set_epi32(s32(v7), s32(v6), s32(v5), s32(v4), s32(v3), s32(v2), s32(v1), s32(v0)); }
      };
      ...
      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::Gather> : public SupportedSimdOperationImplementation
      {
        static __m256u32 Run(const u32* baseAddress, const __m256s32& v)
          { return _mm256_i32gather_epi32(reinterpret_cast<const s32*>(baseAddress), v, sizeof(u32)); }
      };
      ...
      struct SimdOperationImplementation<u32, 8, SimdOperation::GetElement> : public SupportedSimdOperationImplementation
      {
        ...
        static u32 Run(const __m256u32& v, std::integral_constant<usz, Index>)
        {
          if constexpr (Index == 0)
            { return u32(_mm256_cvtsi256_si32(v)); }
          else
            { return u32(_mm256_extract_epi32(v, Index)); }
        }
      };
      ...
      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::CastS32> : public SupportedSimdOperationImplementation
      {
        static __m256s32 Run(const __m256u32& v)
          { return v.m_value; }
      };
      ...
      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::CastS64> : public SupportedSimdOperationImplementation
      {
        static __m256s64 Run(const __m256u32& v)
          { return v.m_value; }
      };

      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::CastU32> : public UnsupportedSimdOperationImplementation
        { };

      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::CastU64> : public SupportedSimdOperationImplementation
      {
        static __m256u64 Run(const __m256u32& v)
          { return v.m_value; }
      };

      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::CastF32> : public SupportedSimdOperationImplementation
      {
        static __m256 Run(const __m256u32& v)
      ...
      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::CastF64> : public SupportedSimdOperationImplementation
      {
        static __m256d Run(const __m256u32& v)
      ...
      struct SimdOperationImplementation<u32, 8, SimdOperation::Shuffle4> : public SupportedSimdOperationImplementation
      {
        ...
        static __m128u32 Run(const __m256u32& v, std::integral_constant<u32, PackedIndices>)
        {
      ...
      {
        static __m256u32 Run(const __m256s32& condition, const __m256u32& trueValue, const __m256u32& falseValue)
      ...
      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::TestMaskNone> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m256u32& v)
          { return _mm256_testz_si256(v, v) != 0; }
      };

      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::TestMaskAny> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m256u32& v)
          { return _mm256_testz_si256(v, v) == 0; }
      };
      ...
      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::TestMaskAll> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m256u32& v)
      ...
      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::TestMaskSome> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m256u32& v)
      ...
      template<>
      struct SimdOperationImplementation<u32, 8, SimdOperation::FromMask> : public SupportedSimdOperationImplementation
      {
        static __m256u32 Run(s32 mask)
        {
          __m256i bits = _mm256_set_epi32(128, 64, 32, 16, 8, 4, 2, 1);
          return _mm256_cmpeq_epi32(_mm256_and_si256(_mm256_set1_epi32(mask), bits), bits);
        }
      };
    }
  }
