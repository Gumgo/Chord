...
import :Math.Simd.SimdOperation;
  ...
  namespace Chord
  {
    export
    {
      ...
      template<>
      struct SimdOperationImplementation<s64, 2, SimdOperation::Gather> : public SupportedSimdOperationImplementation
      {
        static __m128s64 Run(const s64* baseAddress, const __m128s64& v)
          { return _mm_i64gather_epi64(baseAddress, v, sizeof(s64)); }
      };
      ...
      {
        template<usz Index>
        static s64 Run(const __m128s64& v, std::integral_constant<usz, Index>)
        {
      ...
      template<>
      struct SimdOperationImplementation<s64, 2, SimdOperation::NarrowAndCombine> : public UnsupportedSimdOperationImplementation
        { };
      ...
      template<>
      struct SimdOperationImplementation<s64, 2, SimdOperation::TestMaskNone> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m128s64& v)
          { return _mm_testz_si128(v, v) != 0; }
      };

      template<>
      struct SimdOperationImplementation<s64, 2, SimdOperation::TestMaskAny> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m128s64& v)
          { return _mm_testz_si128(v, v) == 0; }
      };
      ...
      template<>
      struct SimdOperationImplementation<s64, 2, SimdOperation::TestMaskAll> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m128s64& v)
      ...
      template<>
      struct SimdOperationImplementation<s64, 2, SimdOperation::TestMaskSome> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m128s64& v)
      ...
      template<>
      struct SimdOperationImplementation<s64, 2, SimdOperation::FromMask> : public SupportedSimdOperationImplementation
      {
        static __m128s64 Run(s32 mask)
        {
