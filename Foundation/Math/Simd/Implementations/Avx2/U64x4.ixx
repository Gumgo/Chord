...
import :Math.Simd.SimdOperation;
  ...
  namespace Chord
  {
    export
    {
      ...
      template<>
      struct SimdOperationImplementation<u64, 4, SimdOperation::Gather> : public SupportedSimdOperationImplementation
      {
        static __m256u64 Run(const u64* baseAddress, const __m256s64& v)
          { return _mm256_i64gather_epi64(reinterpret_cast<const s64*>(baseAddress), v, sizeof(u64)); }
      };
      ...
      template<>
      struct SimdOperationImplementation<u64, 4, SimdOperation::CastS32> : public SupportedSimdOperationImplementation
      {
        static __m256s32 Run(const __m256u64& v)
          { return v.m_value; }
      };

      template<>
      struct SimdOperationImplementation<u64, 4, SimdOperation::CastS64> : public SupportedSimdOperationImplementation
      {
        static __m256s64 Run(const __m256u64& v)
          { return v.m_value; }
      };
      ...
      template<>
      struct SimdOperationImplementation<u64, 4, SimdOperation::CastU32> : public SupportedSimdOperationImplementation
      {
        static __m256u32 Run(const __m256u64& v)
          { return v.m_value; }
      };

      template<>
      struct SimdOperationImplementation<u64, 4, SimdOperation::CastU64> : public UnsupportedSimdOperationImplementation
        { };

      template<>
      struct SimdOperationImplementation<u64, 4, SimdOperation::CastF32> : public SupportedSimdOperationImplementation
      {
        static __m256 Run(const __m256u64& v)
          { return _mm256_castsi256_ps(v); }
      };

      template<>
      struct SimdOperationImplementation<u64, 4, SimdOperation::CastF64> : public SupportedSimdOperationImplementation
      {
        static __m256d Run(const __m256u64& v)
      ...
      template<>
      struct SimdOperationImplementation<u64, 4, SimdOperation::TestMaskNone> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m256u64& v)
          { return _mm256_testz_si256(v, v) != 0; }
      };

      template<>
      struct SimdOperationImplementation<u64, 4, SimdOperation::TestMaskAny> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m256u64& v)
          { return _mm256_testz_si256(v, v) == 0; }
      };
      ...
      template<>
      struct SimdOperationImplementation<u64, 4, SimdOperation::TestMaskAll> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m256u64& v)
      ...
      template<>
      struct SimdOperationImplementation<u64, 4, SimdOperation::TestMaskSome> : public SupportedSimdOperationImplementation
      {
        static bool Run(const __m256u64& v)
      ...
      template<>
      struct SimdOperationImplementation<u64, 4, SimdOperation::FromMask> : public SupportedSimdOperationImplementation
      {
        static __m256u64 Run(s32 mask)
        {
