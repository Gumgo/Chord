  ...
  public TestNativeLibraryRegistry()
  {
    ...
    _coreNativeLibrary = new()
    {
      ...
      [
        ...
        CreateSimpleFunction(CoreNativeLibrary.IndexConstFloatFloat, (float?[] x, float y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexFloatDouble, (float?[] x, double y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexConstFloatDouble, (float?[] x, double y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexFloatInt, (float?[] x, int y) => Index(x, y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexConstFloatInt, (float?[] x, int y) => Index(x, y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexDoubleFloat, (double?[] x, float y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexConstDoubleFloat, (double?[] x, float y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexDoubleDouble, (double?[] x, double y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexConstDoubleDouble, (double?[] x, double y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexDoubleInt, (double?[] x, int y) => Index(x, y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexConstDoubleInt, (double?[] x, int y) => Index(x, y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexIntFloat, (int?[] x, float y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexConstIntFloat, (int?[] x, float y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexIntDouble, (int?[] x, double y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexConstIntDouble, (int?[] x, double y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexIntInt, (int?[] x, int y) => Index(x, y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexConstIntInt, (int?[] x, int y) => Index(x, y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexBoolFloat, (bool?[] x, float y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexConstBoolFloat, (bool?[] x, float y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexBoolDouble, (bool?[] x, double y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexConstBoolDouble, (bool?[] x, double y) => Index(x, (int)y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexBoolInt, (bool?[] x, int y) => Index(x, y)),
        CreateSimpleFunction(CoreNativeLibrary.IndexConstBoolInt, (bool?[] x, int y) => Index(x, y)),
